(function () {
    var DragDrop, Kaleidoscope, c, dragger, gui, image, kaleidoscope, onChange, onMouseMoved, options, tr, tx, ty, update, _i, _len, _ref, __bind = function (fn, me) {
        return function () {
    ...
    image.src = 'http://schaek.be/images/schaek.jpg';
